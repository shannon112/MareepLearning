...
for t in range(iter_time):
    ...
    train_loss_list.append(sqrt_loss)
    #if(t%1000==0):
    if(t):
...
plt.plot(range(iter_time), train_loss_list,label="train_loss")
plt.plot(range(iter_time-1), valid_loss_list,label="valid_loss")
