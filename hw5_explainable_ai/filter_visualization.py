...
if __name__ == "__main__":
    ...
    filter_activations, filter_visualization = filter_explaination(images, model, cnnid=14, filterid=0, iteration=100, lr=0.1)
    print(images.shape)
    ...
    plt.savefig(os.path.join(output_dir,"filter_visualization"))
    #plt.show()
    plt.close()
    ...
    figure_name = os.path.join(output_dir, 'filter_activations_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.png'.format(
